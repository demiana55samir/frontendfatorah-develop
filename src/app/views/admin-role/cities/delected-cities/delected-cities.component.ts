...
@Component({
  selector: 'app-delected-cities',
  templateUrl: './delected-cities.component.html',
  styleUrls: ['./delected-cities.component.scss']
})
export class DelectedCitiesComponent implements OnInit {
  ...
  getAllData(filters : any){
    ...
    let getUrl = 'api/admin/cities/deleted';
