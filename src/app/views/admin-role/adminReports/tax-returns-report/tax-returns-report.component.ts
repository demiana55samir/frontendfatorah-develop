...
import { taxReport } from '@modules/report';
...
@Component({
  selector: 'app-tax-returns-report',
  templateUrl: './tax-returns-report.component.html',
  styleUrls: ['./tax-returns-report.component.scss']
})
export class TaxReturnsReportComponent implements OnInit {
  ...
  getReport(){
    ...
    this.subs.add(this.http.getReq('api/admin/reports/revenues/tax_returns',{params:params}).subscribe({
      next:res=>{
