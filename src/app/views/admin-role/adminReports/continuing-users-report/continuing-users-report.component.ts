...
@Component({
  selector: 'app-continuing-users-report',
  templateUrl: './continuing-users-report.component.html',
  styleUrls: ['./continuing-users-report.component.scss']
})
export class ContinuingUsersReportComponent implements OnInit {
...
constructor(private http:HttpService,private changeLang:ChangeLanguageService,
  ...
  getUsersReport(params:any){
   return this.http.getReq('api/admin/reports/regular/users',{params:params})
  }
