...
@Component({
  selector: 'app-deleted-entities',
  templateUrl: './deleted-entities.component.html',
  styleUrls: ['./deleted-entities.component.scss']
})
export class DeletedEntitiesComponent implements OnInit {
  selectedValue!:any
  searchWord:string = '';
  ...
  getAllData(filters : any){
    ...
    let getUrl = 'api/admin/company_types/deleted';
