...
export class AllActivitiesComponent implements OnInit {
  ...
  columnsArray:columnHeaders[]= [
   ...
   controlArray:ControlItem[]=[
    ...
    {
      nameAR:'تعديل بيانات النشاط',
      nameEN:'Edit activity Details',
      route:{
        path:'/admin/settings/activities/activity-data/edit/',
        attribute:'id'
      },
      popUp:''
    },
    {
      nameAR:'حذف بيانات النشاط',
      nameEN:'Delete Activity',
      route:{
        path:'',
        attribute:'id'
      },
      popUp:'DeleteAdminActivities'
    }
  ...
  getAllData(filters : any){
    ...
    let getUrl = 'api/admin/business_types';
