...
@Component({
  selector: 'app-All-receipt-voucher',
  templateUrl: './All-receipt-voucher.component.html',
  styleUrls: ['./All-receipt-voucher.component.scss']
})
export class AllReceiptVoucherComponent implements OnInit {
  searchWord:string = '';
