...
currentDuration:any
  ...
  getSalesReport(){
    ...
    this.subs.add(this.http.getReq('api/dashboard/reports/collections',{params:params}).subscribe({
      next:res=>{
        this.salesData=res.data.collection_report
